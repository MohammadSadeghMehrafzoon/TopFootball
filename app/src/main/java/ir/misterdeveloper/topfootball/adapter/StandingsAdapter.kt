...
class StandingsAdapter(
...
) : RecyclerView.Adapter<StandingsAdapter.StandingVH>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StandingsAdapter.StandingVH {
        val view: View =
            LayoutInflater.from(parent.context).inflate(R.layout.card_standing, null)
        return StandingVH(view)
    }

    override fun onBindViewHolder(holder: StandingsAdapter.StandingVH, position: Int) {
    ...
    inner class StandingVH(@NonNull itemView: View) : RecyclerView.ViewHolder(itemView) {
